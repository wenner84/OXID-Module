...
[{* bsbs hinzu für Modul cw_alt_price *}]
                 <tr>
                    <td class="edittext">
                    </td>	
                    <td class="edittext" nowrap>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICED" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpriced->fldmax_length}]" name="editval[oxarticles__cwpriced]" value="[{$edit->oxarticles__cwpriced->value}]" [{ $readonly }]>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEE" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpricee->fldmax_length}]" name="editval[oxarticles__cwpricee]" value="[{$edit->oxarticles__cwpricee->value}]" [{ $readonly }]>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEF" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpricef->fldmax_length}]" name="editval[oxarticles__cwpricef]" value="[{$edit->oxarticles__cwpricef->value}]" [{ $readonly }]>
                 ...
                 <tr>
                    ...
                    <td class="edittext" nowrap>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEG" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpriced->fldmax_length}]" name="editval[oxarticles__cwpriceg]" value="[{$edit->oxarticles__cwpriceg->value}]" [{ $readonly }]>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEH" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpricee->fldmax_length}]" name="editval[oxarticles__cwpriceh]" value="[{$edit->oxarticles__cwpriceh->value}]" [{ $readonly }]>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEI" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpricef->fldmax_length}]" name="editval[oxarticles__cwpricei]" value="[{$edit->oxarticles__cwpricei->value}]" [{ $readonly }]>
				[{ oxmultilang ident="ARTICLE_MAIN_PRICEJ" }] <input type="text" class="editinput" size="4" maxlength="[{$edit->oxarticles__cwpricef->fldmax_length}]" name="editval[oxarticles__cwpricej]" value="[{$edit->oxarticles__cwpricej->value}]" [{ $readonly }]>

                    </td>
                  </tr>

[{* bsbs ende cw_alt_price *}]
                  <tr>
                    <td class="edittext">
